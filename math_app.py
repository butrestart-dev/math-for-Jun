...
**🏢 각기둥 (기둥 모양)**
위와 아래가 똑같은 모양이고 평행해요. 옆에서 보면 **직사각형(네모)**입니다.
* **삼각기둥 예시:** 삼각김밥, 토블론 초콜릿
* **사각기둥 예시:** 각티슈, 택배 상자, 아파트

**⛺ 각뿔 (뿔 모양)**
바닥은 평평하지만 위는 뾰족해요. 옆에서 보면 **삼각형(세모)**입니다.
* **사각뿔 예시:** 이집트 피라미드, 텐트
* **원뿔 예시:** 꼬깔모자, 아이스크림 콘
...
* 상황: 사과 3개와 배 2개가 있어요.
* 표현: **3 : 2** (3 대 2)
* **주의!** 기호 오른쪽에 있는 수(2)가 **기준**입니다. ("2에 대한 3의 비")

**2. 비율 (Rate) - "얼마나 차지해?"**
기준(뒤에 있는 수)을 1로 봤을 때의 크기예요. (분수나 소수로 나타내요)
**공식: 비율 = 비교하는 양(앞) ÷ 기준량(뒤)**

> **🔎 예시 1: 농구 슛**
> 10번 던져서 5번 골인했어요.
> * **비** 👉 5 : 10
> * **비율** 👉 5 ÷ 10 = 5/10 = **0.5 (절반 성공!)**

> **🔎 예시 2: 할인 행사**
> 1000원짜리 과자를 100원 깎아줬어요.
> * **비** 👉 100 : 1000
> * **비율** 👉 100 ÷ 1000 = 1/10 = **0.1 (10% 할인)**
"""
}
...
def main():
    ...
    if st.session_state.step == 'intro':
        ...
        # HTML 태그 없이 st.info만 사용하여 내용 표시
